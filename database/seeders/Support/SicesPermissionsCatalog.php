...
final class SicesPermissionsCatalog
{
    ...
    public static function allRegisterablePermissionNames(): array
    {
        return array_values(array_unique(array_merge(
            ...
            [
                ...
                'control_escolar.catalogos.ver', 'control_escolar.catalogos.configurar',
                'estatus_academicos.ver', 'estatus_academicos.crear', 'estatus_academicos.editar',
                'estatus_matricula.ver', 'estatus_matricula.crear', 'estatus_matricula.editar',
                'escalas_calificacion.ver', 'escalas_calificacion.crear', 'escalas_calificacion.editar',
            ],
        )));
    }
    ...
    public static function modularPermissions(): array
    {
        ...
        $extra = [
            ...
            'documentos.crear',
            'documentos.editar',
            'documentos.enviar_validacion',
            'documentos.observaciones.atender',
            'documentos.descargar',
            'documentos.acuse.descargar',
            'documentos.exportar',
            'documentos.tipos.ver',
            'documentos.pendientes.ver',
            'bajas_cambios.ver',
            'bajas_cambios.crear',
            'bajas_cambios.editar',
            'bajas_cambios.revisar',
            'bajas_cambios.aprobar',
            'bajas_cambios.rechazar',
            'bajas_cambios.observar',
            'bajas_cambios.aplicar',
            'bajas_cambios.cancelar',
            'bajas_cambios.exportar',
            'bajas_cambios.dictamen.generar',
            'bajas_cambios.dictamen.descargar',
            'bajas_cambios.aprobar_masivo',
            'bajas_cambios.rechazar_masivo',
            'documentos.aprobar_academicamente',
            'validacion_normativa.aprobar',
            'asistencia.capturar',
            'apariencia_sistema.ver',
    ...
    public static function modularPermissionsByRole(): array
    {
        return [
            ...
            'educacion_superior' => [
                ...
                'estatus_academicos.ver', 'estatus_matricula.ver', 'escalas_calificacion.ver',
                'materias.ver',
                'expedientes.ver',
            ...
            'control_escolar_escuela' => [
                ...
                'expedientes.validar', 'expedientes.observar', 'expedientes.exportar',
                'bajas_cambios.ver', 'bajas_cambios.crear', 'bajas_cambios.editar',
                'bajas_cambios.revisar', 'bajas_cambios.aprobar', 'bajas_cambios.rechazar',
                'bajas_cambios.observar', 'bajas_cambios.aplicar', 'bajas_cambios.cancelar',
                'bajas_cambios.exportar', 'bajas_cambios.dictamen.generar', 'bajas_cambios.dictamen.descargar',
                'bajas_cambios.aprobar_masivo', 'bajas_cambios.rechazar_masivo',
                'expedientes.documentos.cargar', 'expedientes.documentos.descargar',
                'expedientes.actividad.ver', 'expedientes.validacion.masiva', 'expedientes.observacion.masiva',
                'alumnos.ver', 'alumnos.crear', 'alumnos.editar', 'alumnos.importar', 'alumnos.exportar',
                ...
                'reinscripciones.cancelar', 'reinscripciones.exportar',
                'reinscripciones.ficha.generar', 'reinscripciones.ficha.descargar',
                'reinscripciones.desbloqueo.masivo', 'reinscripciones.completar.masivo',
                ...
                'calificaciones.editar', 'calificaciones.importar', 'calificaciones.exportar',
                'calificaciones.historial.ver', 'calificaciones.correccion.solicitar', 'calificaciones.plantilla.descargar',
                'trayectoria.ver', 'trayectoria.recalcular', 'trayectoria.exportar',
                'kardex.ver', 'kardex.exportar',
                'documentos.ver', 'documentos.crear', 'documentos.crear_borrador', 'documentos.editar',
                'documentos.enviar_revision', 'documentos.enviar_validacion',
                'documentos.observaciones.atender', 'documentos.cancelar', 'documentos.descargar',
                'documentos.acuse.descargar', 'documentos.exportar', 'documentos.tipos.ver', 'documentos.pendientes.ver',
    ...
    public static function legacyToModularParity(): array
    {
        return [
            ...
            'enviar_revision' => ['documentos.enviar_revision', 'documentos.enviar_validacion'],
     ...
     * @return list<string>
     */
    public static function forbiddenForAdmin(): array
    {
        return [
            'catalogos.tecnicos.ver',
        ];
    ...
    public static function forbiddenForResponsableCertificacionTitulacion(): array
    {
        return [
            ...
            'certificacion.firmar',
            'certificacion.obtener_resultado_final',

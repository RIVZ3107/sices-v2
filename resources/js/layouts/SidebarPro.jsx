...
const fallbackMenuTreeByRole = {
    superadmin: [
        ...
        },
        {
            ...
            order: 3,
            children: [
                { label: 'Usuarios y roles', route: '/app/admin/usuarios-roles', icon: 'users', order: 1 },
                { label: 'Menús del sistema', route: '/app/admin/menus', icon: 'panel', order: 2 },
                { label: 'Catálogos técnicos', route: '/app/admin/catalogos', icon: 'settings', order: 3 },
                { label: 'Auditoría', route: '/app/auditoria', icon: 'audit', order: 4 },
            ],
        },
    ],
    ...
    control_escolar_escuela: [
        ...
        },
        {
            ...
            children: [
                ...
                { label: 'Trayectoria académica', route: '/app/control-escolar/trayectoria', icon: 'trayectoria', order: 5 },
                ...
                { label: 'Observaciones', route: '/app/control-escolar/observaciones', icon: 'audit', order: 8 },
                { label: 'Reportes', route: '/app/control-escolar/reportes', icon: 'report', order: 9 },
            ],
        },
    ],
    ...
    sistemas: [
        ...
        },
        {
            ...
            children: [
                ...
                { label: 'Configuración', route: '/app/sistemas/configuracion', icon: 'integrations', order: 2 },
                { label: 'Logs técnicos', route: '/app/sistemas/logs', icon: 'logs', order: 3 },
            ],
        },
    ],

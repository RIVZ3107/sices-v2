...
import { getProgressSeverity } from '../../../utils/reinscripcionUx';

export function ReinscripcionProgressBar({ avance }) {
    ...
    return (
        <div style={{ minWidth: 90 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 11, marginBottom: 4 }}>
                <span style={{ color: '#64748b' }}>{avance?.completados ?? 0}/{avance?.total ?? 0}</span>

...
final class SistemasDashboardService
{
    ...
    public function build(User $user): array
    {
        ...
        $logsIntegracion = IntegracionLog::query()->count();
        ...
        return [
            ...
            'cards' => [
                ...
                ['key' => 'integraciones', 'title' => 'Integraciones (logs)', 'value' => max(0, $logsIntegracion), 'href' => '/app/sistemas/configuracion'],
                ['key' => 'logs', 'title' => 'Logs técnicos', 'value' => max(0, $logsIntegracion), 'href' => '/app/sistemas/logs'],
